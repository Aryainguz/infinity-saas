<script lang="ts">
  ...
  const contractAddress = "KT1MjasZbu3aKmb6epEEbXETPkGCEEsFgdnv";
  ...
  <div class="container">
    ...
    {#if userAddress}
        ...
        <div class="user-nfts">
          ...
          {#if nftStorage}
            [ {#each userNfts.reverse() as nft, index}
              <a
                href={`https://bronze-adequate-harrier-830.mypinata.cloud//ipfs/${nft.ipfsHash}`}
                target="_blank"
      ...
      {#if newNft}
        ...
        <div>
          <a
            href={`https://bronze-adequate-harrier-830.mypinata.cloud//ipfs/${newNft.imageHash}`}
            target="_blank"
            rel="noopener noreferrer nofollow"
          >
        ...
        <div>
          <a
            href={`https://bronze-adequate-harrier-830.mypinata.cloud//ipfs/${newNft.metadataHash}`}
            target="_blank"
            rel="noopener noreferrer nofollow"
          >
